  ...
  const [alumnos] = useState([
    {
      ...
      seccion: '4° A',
      cuotas: [
        { id: 1, mes: 'Marzo 2025', monto: 45000, vencida: false, codigo: 'ECEP-2025-03-001' },
        { id: 2, mes: 'Abril 2025', monto: 45000, vencida: true, codigo: 'ECEP-2025-04-001' },
        { id: 3, mes: 'Mayo 2025', monto: 47000, vencida: false, codigo: 'ECEP-2025-05-001' }
      ],
    ...
    },
    {
      ...
      seccion: 'Sala 5',
      cuotas: [
        { id: 1, mes: 'Marzo 2025', monto: 42000, vencida: false, codigo: 'ECEP-2025-03-002' },
        { id: 2, mes: 'Abril 2025', monto: 42000, vencida: false, codigo: 'ECEP-2025-04-002' }
      ],
            ...
            <CardContent className="space-y-4">
              ...
              <div className="border rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Badge variant={alumno.matricula.pagada ? 'default' : 'destructive'}>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {alumno.cuotas.map((cuota) => (
                    <div key={cuota.id} className="flex items-center justify-between p-2 border rounded">
                      <div>
                        <p className="font-medium">{cuota.mes}</p>
                        <p className="text-sm text-gray-600">{formatMonto(cuota.monto)}</p>
                      </div>
                      <div className="text-right">
                        <Badge variant={cuota.vencida ? 'destructive' : 'secondary'}>
                          {cuota.vencida ? 'Vencida' : 'Vigente'}
                        </Badge>
                        <p className="text-xs text-gray-500 mt-1">{cuota.codigo}</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                    ...
                    <p className="text-sm text-gray-600">Haga clic para subir archivo</p>
                  </div>
                </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 border rounded-lg">
              <div>
                ...
                <p className="text-sm text-gray-600">Todas las secciones - Vence: 10/03/2025</p>
              </div>
              <div className="text-right">
            ...
            <div className="flex items-center justify-between p-3 border rounded-lg">
              <div>
                ...
                <p className="text-sm text-gray-600">Todas las secciones - Vence: 15/02/2025</p>
              </div>
              <div className="text-right">
                    ...
                    {personal.map((persona) => (
                      <div key={persona.id} className="flex items-center justify-between p-3 border rounded-lg">
                        ...
                        <div className="flex items-center space-x-4">
                          <div className="text-right">
                            <p className="font-medium">{formatMonto(persona.sueldo)}</p>
                            <p className="text-sm text-gray-600">{persona.fecha}</p>
                          </div>
                          <Badge variant={persona.recibido ? 'default' : 'secondary'}>
                            {persona.recibido ? (
